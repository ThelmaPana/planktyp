#--------------------------------------------------------------------------#
# Project: planktyp
# Script purpose: Run analyses on a subsample of mesopelagic sup profiles to limit oversampling effect of some areas
...
message(nrow(subset), " profiles in mesopelagic sup layer")
...
message("Subset of ", nrow(sub_meta), " profiles from ", nrow(meta), " in mesopelagic sup layer")
...
# Plot dendrogram
png(file = "plots/subsample/mesosup/13.plankton_dendrogram.png", width = 9.79, height = 7.96, units = "in", res = 300)
plot(clust_zoo, main = "Cluster dendrogram on plankton data in mesopelagic sup layer")
...
ggsave(file = "plots/subsample/mesosup/13.plankton_clusters_profile_nb.png")
...
ggsave(file = "plots/subsample/mesosup/13.plankton_pca_variance_explained.png")
...
ggplot() +
  ...
  # Plot title
  ggtitle("PCA biplot of mesopelagic sup profiles, PC1 and PC2") +
  # Nice theme
  theme_classic() +
...
ggsave(file = "plots/subsample/mesosup/13.plankton_pca_biplot_1_2.png")
...
ggplot() +
  ...
  labs(color = "Plankton clusters") +
  # Plot title
  ggtitle("PCA biplot of mesopelagic sup profiles, PC2 and PC3") +
  # Nice theme
  theme_classic() +
  # Legend position at the bottom
  theme(legend.position = "bottom") +
...
ggsave(file = "plots/subsample/mesosup/13.plankton_pca_biplot_2_3.png")
...
ind_plot %>% 
  ...
  # Bigger points in the legend, legend title on top
  guides(colour = guide_legend(override.aes = list(size=2), title.position="top")) +
  ggtitle("Map of mesopelagic sup plankton clusters")
ggsave(file = "plots/subsample/mesosup/13.plankton_clusters_map.png")
...
comp %>% 
  ...
  ggtitle("Composition of mesopelagic sup plankton clusters")
ggsave(file = "plots/subsample/mesosup/13.plankton_clusters_composition.png")
